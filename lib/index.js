      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(_chalk2.default.green('Start installing module ' + _chalk2.default.yellow.bold(command) + ' ...'));
            _context.prev = 2;
            _context.next = 5;
          ...
          case 7:
            ...
            console.log(_chalk2.default.red('Failure of installation module ' + _chalk2.default.yellow.bold(command)));
            process.exit();
...
// 核心命令
var coreCommand = ['init', 'dev', 'build', 'install', 'plugin', 'sync'];
      ...
      if (!pluginPool[name]) {
        ...
        try {
          ...
          if (!ifCoreCommand(name.substring(14))) {
            _commander2.default.command(name.substring(14)).description(pluginPkg.description);
          }
          // 保存 package 文件信息，检查版本更新需要
          pluginPackagePath[name.substring(14)] = packageJson;
        } catch (e) {
          console.log(_chalk2.default.red('Exception occurred when reading plugin information.'));
          process.exit(0);
        }
      }
    });
